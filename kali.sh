...
function get_rootfs() {
    ...
    printf "${green}[*] Downloading rootfs...${reset}\n\n"
...
if grep -q "killer" ${CHROOT}/etc/passwd; then
    KALIUSR="1";
else
    KALIUSR="0";
fi
...
function print_banner() {
    ...
    printf "${red}##                                              ##\n"  
    printf "${green}##                 Developed by Mr.KiLLeR29 ##\n"
...
print_bannerprintf "${green}[=] NetHunter for Termux installed successfully${reset}\n\n" 
...
## Developed by Mr.KiLLeR29

## If you like my work please follow me on github Mr.KiLLeR29
